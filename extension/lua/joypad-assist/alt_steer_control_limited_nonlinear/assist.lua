...
local firstStageSensitivity = 0.3 --Sensitivity of first stage (upper hemisphere). 0 to 1. Equals to steer/angleRotation
...
function script.update(dt)
    ...
    rotationMagnitude = math.clamp(rotationMagnitude, -1, 1)
